...
public class PatchBulletIgnoreSubscriptionReservationStrategy extends AbstractPatchBulletStrategy {

    public PatchBulletIgnoreSubscriptionReservationStrategy(BulletRepository bulletRepository,
