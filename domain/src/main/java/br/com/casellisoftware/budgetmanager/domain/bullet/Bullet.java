 ...
 */
public final class Bullet implements FlagAware {
    ...
    public Bullet(String id, String description, Money budget, Money remaining, String walletId, FlagEnum flag) {
        this(id, LEGACY_OWNER_ID, description, budget, remaining, walletId, flag);
    }

    public Bullet(String id, String ownerId, String description, Money budget, Money remaining, String walletId, FlagEnum flag) {
        this.id = id;
    ...
    public Bullet debit(Money amount) {
        ...
        return new Bullet(this.id, this.ownerId, this.description, this.budget, newRemaining, this.walletId, this.flag);
    }
    ...
    public Bullet patch(BulletPatch patch) {
        ...
        return new Bullet(this.id, this.ownerId, patchedDescription, patchedBudget, patchedRemaining, patchedWalletId, patchedFlag);
    }
    ...
    public static Bullet create(String description, Money budget, Money remaining, String walletId) {
        return create(description, budget, remaining, walletId, FlagEnum.NONE, LEGACY_OWNER_ID);
    }

    public static Bullet create(String description, Money budget, Money remaining, String walletId, FlagEnum flag) {
        return create(description, budget, remaining, walletId, flag, LEGACY_OWNER_ID);
    }

    public static Bullet create(String description, Money budget, Money remaining, String walletId, FlagEnum flag, String ownerId) {
        return new Bullet(UUID.randomUUID().toString(), ownerId, description, budget, remaining, walletId, flag);
    }

    public static Bullet rebuild(String id, String description, Money budget, Money remaining, String walletId) {
        return rebuild(id, description, budget, remaining, walletId, FlagEnum.NONE, LEGACY_OWNER_ID);
    }

    public static Bullet rebuild(String id, String description, Money budget, Money remaining, String walletId, FlagEnum flag) {
        return rebuild(id, description, budget, remaining, walletId, flag, LEGACY_OWNER_ID);
    }

    public static Bullet rebuild(String id, String description, Money budget, Money remaining, String walletId, FlagEnum flag, String ownerId) {
        return new Bullet(id, ownerId, description, budget, remaining, walletId, flag);
    }
    ...
    public boolean equals(Object o) {
        return o instanceof Bullet bullet
                && Objects.equals(id, bullet.id)
                && Objects.equals(ownerId, bullet.ownerId)
                && Objects.equals(flag, bullet.flag);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, ownerId, flag);
    }
