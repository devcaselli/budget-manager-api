...
public record Money(BigDecimal amount, Currency currency) {
    ...
    /**
     * Returns a new {@code Money} representing the result of crediting {@code amount}
     * onto this value (symmetric inverse of {@link #debitBy(Money)}). Fails if
     * {@code amount} is not positive or currencies mismatch.
     */
    public Money creditBy(Money amount) {
        Objects.requireNonNull(amount, "amount must not be null");
        if (!amount.isPositive()) {
