...
class NotFoundExceptionContractTest {
    ...
    void notFoundExceptions_haveSingleStringIdConstructor() {
        ...
        assertSingleStringConstructor(SubscriptionNotFoundException.class);
        assertSingleStringConstructor(SubscriptionChargeNotFoundException.class);
    ...
    void notFoundExceptions_wrapIdIntoStandardMessage() {
        ...
        assertThat(new SubscriptionNotFoundException("subscription-1"))
                .hasMessage("Subscription not found: subscription-1");
        assertThat(new SubscriptionChargeNotFoundException("charge-1"))
                .hasMessage("Subscription charge not found: charge-1");
