...
class ExpenseRestMapperTest {
    ...
    void toPagedResponse_mapsAllFieldsAndContent() {
        ExpenseOutput output1 = new ExpenseOutput(
                "id-1", "lunch", new BigDecimal("10.50"), PURCHASE_DATE, "wallet-1", CREDIT_CARD_ID,
                new BigDecimal("10.50"), List.of(), FlagEnum.NONE);
        ExpenseOutput output2 = new ExpenseOutput(
                "id-2", "coffee", new BigDecimal("5.00"), PURCHASE_DATE, "wallet-1", CREDIT_CARD_ID,
                new BigDecimal("5.00"), List.of(), FlagEnum.NONE);
