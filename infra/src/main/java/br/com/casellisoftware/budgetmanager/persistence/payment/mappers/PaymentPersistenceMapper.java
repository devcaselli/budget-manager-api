...
public interface PaymentPersistenceMapper {
    ...
    default Payment toDomain(PaymentDocument document) {
        ...
        return Payment.rebuild(
                ...
                document.getOwnerId() == null ? Payment.LEGACY_OWNER_ID : document.getOwnerId(),
                document.getKind() == null ? PaymentKind.NORMAL : document.getKind(),
                document.getPayerId(),
                document.getShareId(),
                document.isReversal(),
                document.getReversedPaymentId()
        );
    }
