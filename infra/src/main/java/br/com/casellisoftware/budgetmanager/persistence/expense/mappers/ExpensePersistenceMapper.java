...
public interface ExpensePersistenceMapper {
    ...
    @Mapping(target = "creditCardId", source = "expense.creditCardId")
    @Mapping(target = "installmentId", source = "expense.installmentId")
    @Mapping(target = "hidden", source = "expense.hidden")
    ...
    default Expense toDomain(ExpenseDocument document) {
        ...
        return new Expense(
                ...
                document.isHidden(),
                document.getInstallmentId(),
                document.getOwnerId() == null ? Expense.LEGACY_OWNER_ID : document.getOwnerId(),
                document.getSourcePendingId()
        );
    }
